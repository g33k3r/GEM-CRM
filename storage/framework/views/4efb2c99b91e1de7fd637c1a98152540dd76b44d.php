                                        ...
                                        <div class="card-body" style="height:100%">
                                            <div class="tab-content mo-mt-2" id="v-pills-tabContent">
                                                <div class="tab-pane fade active show" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                                    ...
                                                    <form method="post" enctype="multipart/form-data" action="<?php echo e(url('/updateProfile')); ?>">
                                                        <?php echo csrf_field(); ?>
                                                        <div class="row" style="margin-top:50px;border-bottom: 2px solid #F1F5F9;padding-bottom: 30px;">
                                                            <div class="col-md-4">
                                                                <div class="uploader">
                                                                    ...
                                                                    ?>
                                                                    <img id="preview" src="<?php echo e($image); ?>" alt="Default Avatar">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="mb-2">
                                                                            ...
                                                                            <input type="text" class="form-control my-input" required placeholder="Jake Paul" name="name" value="<?php echo e(session()->get('adminAuth')[0]['name']); ?>">
                                                                        </div>
                                                                        <div class="mb-2">
                                                                            <label for="" class="label">Email</label>
                                                                            <input type="text" required class="form-control my-input" placeholder="jake@gmail.com" name="email" value="<?php echo e(session()->get('adminAuth')[0]['email']); ?>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="mb-2">
                                                                            <label for="" class="label">Role</label>
                                                                            <input type="text" class="form-control my-input" placeholder="<?php echo e(ucfirst(session()->get('adminAuth')[0]['type'])); ?>" readonly >
                                                                        </div>
                                                                        <div class="mb-2">
                                                                            <label for="" class="label">Contact</label>
                                                                            <input type="text" required class="form-control my-input" placeholder="+92 304 2328820" name="phone" value="<?php echo e(session()->get('adminAuth')[0]['contact']); ?>" id="profilePhone">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="d-flex gap-2 align-items-center mt-3 mb-2">
                                                                ...
                                                                <div>
                                                                    <div class="form-check form-switch form-switch-warning">
                                                                        <input class="form-check-input alert-toggle" type="checkbox" id="follow_up_toggle" data-setting="follow_up" <?php echo e($alertFollowUp === 'true' ? 'checked' : ''); ?>>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    <div class="form-check box-check">
                                                                        <input class="form-check-input alert-freq-checkbox" type="checkbox" value="day_before" id="follow_up_day_before" data-setting="follow_up_freq" <?php echo e(is_array($alertFollowUpFreq) && in_array('day_before', $alertFollowUpFreq) ? 'checked' : ''); ?>>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-check box-check">
                                                                        <input class="form-check-input alert-freq-checkbox" type="checkbox" value="week_before" id="follow_up_week_before" data-setting="follow_up_freq" <?php echo e(is_array($alertFollowUpFreq) && in_array('week_before', $alertFollowUpFreq) ? 'checked' : ''); ?>>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-check box-check">
                                                                        <input class="form-check-input alert-freq-checkbox" type="checkbox" value="month_before" id="follow_up_month_before" data-setting="follow_up_freq" <?php echo e(is_array($alertFollowUpFreq) && in_array('month_before', $alertFollowUpFreq) ? 'checked' : ''); ?>>
                                                    ...
                                                    <div class="row box mb-3">
                                                        <div class="col-md-6">
                                                            <div class="d-flex gap-2 align-items-center mt-3 mb-2">
                                                                ...
                                                                <div>
                                                                    <div class="form-check form-switch form-switch-warning">
                                                                        <input class="form-check-input alert-toggle" type="checkbox" id="upcoming_maintenance_toggle" data-setting="upcoming_maintenance" <?php echo e($alertUpcomingMaintenance === 'true' ? 'checked' : ''); ?>>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <p style="color:#94A3B8" class="mb-0">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    <div class="form-check box-check">
                                                                        <input class="form-check-input alert-freq-checkbox" type="checkbox" value="day_before" id="upcoming_maintenance_day_before" data-setting="upcoming_maintenance_freq" <?php echo e(is_array($alertUpcomingMaintenanceFreq) && in_array('day_before', $alertUpcomingMaintenanceFreq) ? 'checked' : ''); ?>>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-check box-check">
                                                                        <input class="form-check-input alert-freq-checkbox" type="checkbox" value="week_before" id="upcoming_maintenance_week_before" data-setting="upcoming_maintenance_freq" <?php echo e(is_array($alertUpcomingMaintenanceFreq) && in_array('week_before', $alertUpcomingMaintenanceFreq) ? 'checked' : ''); ?>>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-check box-check">
                                                                        <input class="form-check-input alert-freq-checkbox" type="checkbox" value="month_before" id="upcoming_maintenance_month_before" data-setting="upcoming_maintenance_freq" <?php echo e(is_array($alertUpcomingMaintenanceFreq) && in_array('month_before', $alertUpcomingMaintenanceFreq) ? 'checked' : ''); ?>>
                                                    ...
                                                    <div class="row box mb-3">
                                                        <div class="col-md-6">
                                                            <div class="d-flex gap-2 align-items-center mt-3 mb-2">
                                                                ...
                                                                <div>
                                                                    <div class="form-check form-switch form-switch-warning">
                                                                        <input class="form-check-input alert-toggle" type="checkbox" id="overdue_maintenance_toggle" data-setting="overdue_maintenance" <?php echo e($alertOverdueMaintenance === 'true' ? 'checked' : ''); ?>>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    <div class="form-check box-check">
                                                                        <input class="form-check-input alert-freq-checkbox" type="checkbox" value="day_after" id="overdue_maintenance_day_after" data-setting="overdue_maintenance_freq" <?php echo e(is_array($alertOverdueMaintenanceFreq) && in_array('day_after', $alertOverdueMaintenanceFreq) ? 'checked' : ''); ?>>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-check box-check">
                                                                        <input class="form-check-input alert-freq-checkbox" type="checkbox" value="week_after" id="overdue_maintenance_week_after" data-setting="overdue_maintenance_freq" <?php echo e(is_array($alertOverdueMaintenanceFreq) && in_array('week_after', $alertOverdueMaintenanceFreq) ? 'checked' : ''); ?>>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-check box-check">
                                                                        <input class="form-check-input alert-freq-checkbox" type="checkbox" value="month_after" id="overdue_maintenance_month_after" data-setting="overdue_maintenance_freq" <?php echo e(is_array($alertOverdueMaintenanceFreq) && in_array('month_after', $alertOverdueMaintenanceFreq) ? 'checked' : ''); ?>>
                                                ...
                                                <div class="tab-pane fade" id="v-pills-password" role="tabpanel" aria-labelledby="v-pills-password-tab2">
                                                    ...
                                                    <form action="<?php echo e(url('/updatePassword')); ?>" method="post" id="passwordUpdateForm">
                                                        <?php echo csrf_field(); ?>
                                                            ...
                                                            <div class="table-responsive">
                                                                <table class="table" id="teamTable">
                                                                    ...
                                                                    <?php foreach ($team as $v) { ?>
                                                                        <tr data-member-id="<?php echo e($v['id']); ?>" data-member-role="<?php echo e(strtolower($v['type'])); ?>">
                                                                            <td>
                                                                                <span class="tble-clr"><?php echo e(date("d M Y", strtotime($v['created_at']))); ?></span>
                                                                                <p class="mb-0 tble-time"><?php echo e(date("h:i a", strtotime($v['created_at']))); ?></p>
                                                                            </td>
                                                                            <td>
                                                                                <div class="d-flex align-items-center justify-content-between">
                                                                                    <div>
                                                                                        <span class="tble-clr"><?php echo e($v['name']); ?></span>
                                                                                        <p class="mb-0 tble-time"><?php echo e($v['email']); ?></p>
                                                                                    </div>
                                                                                    <div>
                                                                                        <a href="#">
                                                                            ...
                                                                            <td>
                                                                                <span class="tble-clr"><?php echo e($v['contact']); ?></span>
                                                                            </td>
                                                                            <td><span class="tble-clr"><?php echo e(ucfirst($v['type'])); ?></span></td>
                                                                            <td>
                                                                                <span class="<?php echo e(($v['status'] == 'active') ? "active" : (($v['status'] == 'deactive') ? "deactive" : "deactive")); ?>-status">
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <div class="dropdown-menu">
                                                                                    <a class="dropdown-item edit-member-btn" href="#" data-member-id="<?php echo e($v['id']); ?>" data-member-name="<?php echo e($v['name']); ?>" data-member-email="<?php echo e($v['email']); ?>" data-member-contact="<?php echo e($v['contact']); ?>" data-member-type="<?php echo e($v['type']); ?>" data-member-status="<?php echo e($v['status']); ?>">
                                                                                        <i class="ti ti-pencil" style="margin-right:5px"></i>
                                                                                        Edit
                                                                                    </a>
                                                                                    <a class="dropdown-item toggle-status-btn" href="#" data-member-id="<?php echo e($v['id']); ?>" data-member-name="<?php echo e($v['name']); ?>" data-member-status="<?php echo e($v['status']); ?>">
                                                                                        <i class="ti ti-toggle-<?php echo e(($v['status'] == 'active') ? 'left' : 'right'); ?>" style="margin-right:5px"></i>
                                                                                        <?php echo e(($v['status'] == 'active') ? 'Deactivate' : (($v['status'] == 'deactive') ? 'Activate' : 'Activate')); ?>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="table-responsive">
                                                                <table class="table" id="customFieldsTable">
                                                                    ...
                                                                    <tr data-field-id="<?php echo e($v['id']); ?>" data-field-type="<?php echo e($v['type']); ?>">
                                                                        <td>
                                                                            <span class="tble-clr"><?php echo e(date("d M Y", strtotime($v['created_at']))); ?></span>
                                                                            <p class="mb-0 tble-time"><?php echo e(date("h:i a", strtotime($v['created_at']))); ?></p>
                                                                        </td>
                                                                        ...
                                                                        <td>
                                                                                <span class="<?php echo e(($v['status'] == 'visible') ? "active" : "deactive"); ?>-status">
                                                                                    <?php echo e(ucwords($v['status'])); ?>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div class="dropdown-menu">
                                                                                <a class="dropdown-item edit-custom-field-btn" href="#" data-field-id="<?php echo e($v['id']); ?>" data-field-name="<?php echo e($v['name']); ?>" data-field-type="<?php echo e($v['type']); ?>" data-field-status="<?php echo e($v['status']); ?>" data-field-values="<?php echo e($v['values']); ?>">
                                                                                    <i class="ti ti-pencil" style="margin-right:5px"></i>
                                                                                    Edit
                                                                                </a>
                                                                                <a class="dropdown-item delete-custom-field-btn" href="#" data-field-id="<?php echo e($v['id']); ?>" data-field-name="<?php echo e($v['name']); ?>">
                                                            ...
                                                            <div class="table-responsive">
                                                                <table class="table" id="otherItemsTable">
                                                                    ...
                                                                    <tr data-item-id="<?php echo e($item['id']); ?>">
                                                                        <td>
                                                                            <span class="tble-clr"><?php echo e(date("d M Y", strtotime($item['created_at']))); ?></span>
                                                                            <p class="mb-0 tble-time"><?php echo e(date("h:i a", strtotime($item['created_at']))); ?></p>
                                                                        </td>
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <?php echo e($item['custom_field_names_display']); ?>

                                                                        </td>
                                                                        <td>
                                                                            <span class="active-status"><?php echo e($item['useage']); ?></span>
                                                                        </td>
                                                                        <td>
                                                                            <a href="#" type="button" class="dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                            ...
                                                                            <div class="dropdown-menu">
                                                                                <a class="dropdown-item edit-other-item-btn" href="#" data-item-id="<?php echo e($item['id']); ?>" data-item-name="<?php echo e($item['name']); ?>" data-item-fields="<?php echo e($item['fields']); ?>">
                                                                                    <i class="ti ti-pencil" style="margin-right:5px"></i>
                                                                                    Edit
                                                                                </a>
                                                                                <a class="dropdown-item delete-other-item-btn" href="#" data-item-id="<?php echo e($item['id']); ?>" data-item-name="<?php echo e($item['name']); ?>" data-item-usage="<?php echo e($item['useage']); ?>">
                                                                                    <i class="ti ti-trash" style="margin-right:5px"></i>
                                                                                    Delete
                                                                                </a>
                                                                            </div>
    ...
    <div class="modal fade" id="addMemberModal" tabindex="-1" aria-labelledby="addMemberModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="addMemberForm" method="POST" action="<?php echo e(url('/addMember')); ?>">
                    <?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="editMemberModal" tabindex="-1" aria-labelledby="editMemberModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="editMemberForm" method="POST" action="<?php echo e(url('/updateMember')); ?>">
                    <?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="statusConfirmationModal" tabindex="-1" aria-labelledby="statusConfirmationModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="statusConfirmationForm" method="POST" action="<?php echo e(url('/toggleMemberStatus')); ?>">
                    <?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="addCustomFieldModal" tabindex="-1" aria-labelledby="addCustomFieldModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="addCustomFieldForm" method="POST" action="<?php echo e(url('/addCustomField')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="mb-3">
    ...
    <div class="modal fade" id="editCustomFieldModal" tabindex="-1" aria-labelledby="editCustomFieldModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="editCustomFieldForm" method="POST" action="<?php echo e(url('/updateCustomField')); ?>">
                    <?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="deleteCustomFieldModal" tabindex="-1" aria-labelledby="deleteCustomFieldModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="deleteCustomFieldForm" method="POST" action="<?php echo e(url('/deleteCustomField')); ?>">
                    <?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="addOtherItemModal" tabindex="-1" aria-labelledby="addOtherItemModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="addOtherItemForm" method="POST" action="<?php echo e(url('/addOtherItems')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select selectpicker" id="customFieldsSelect" name="custom_fields[]" multiple data-live-search="true" title="Select custom fields" required>
                                <?php $__currentLoopData = $customFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="modal fade" id="editOtherItemModal" tabindex="-1" aria-labelledby="editOtherItemModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="editOtherItemForm" method="POST" action="<?php echo e(url('/updateOtherItems')); ?>">
                    <?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="deleteOtherItemModal" tabindex="-1" aria-labelledby="deleteOtherItemModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="deleteOtherItemForm" method="POST" action="<?php echo e(url('/deleteOtherItems')); ?>">
                    <?php echo csrf_field(); ?>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function saveAlertSettings() {
                ...
                fetch('<?php echo e(url("/api/alert-settings")); ?>', {
                    method: 'POST',
                    headers: {
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u246429533/domains/gemdentalrepair.com/public_html/crm/resources/views/settings.blade.php ENDPATH**/ ?>