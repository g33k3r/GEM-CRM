...
<head>
    ...
    <link href="<?php echo e(asset('public/')); ?>/assets/libs/simple-datatables/style.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('public/')); ?>/assets/libs/fullcalendar/main.min.css" rel="stylesheet" type="text/css" />
    ...
    <nav class="navbar-custom">
        <ul class="list-unstyled topbar-nav float-end mb-0">
            ...
            <li class="notification-list" style="border-right:1px solid #FFFFFF26">
                <a class="nav-link arrow-none nav-icon" href="<?php echo e(url('/settings')); ?>" >
            ...
            <li class="dropdown d-flex align-items-center text-white gap-1">
                <a class="nav-link dropdown-toggle nav-user"  href="#" role="button">
                    <div class="d-flex align-items-center">
                        ...
                        ?>
                        <img src="<?php echo e($image); ?>" alt="profile-user" class="rounded-circle me-0 me-md-2 thumb-sm" />
                        <div class="user-name">
                            <span class="d-none d-lg-block fw-semibold font-12 text-white">
                                <?php echo e(session()->get('adminAuth')[0]['name']); ?>

                            </span>
                            <small class="d-none d-lg-block font-11 ">
                                <?php echo e((session()->get('adminAuth')[0]['type'] == 'admin') ? "Admin" : "Worker"); ?> Account
                            </small>
                        </div>
                    </div>
                </a>
        ...
        <div class="navbar-custom-menu">
            <div id="navigation">
                ...
                <ul class="navigation-menu">
                    ...
                    <li class="nav-item dropdown parent-menu-item">
                        <a class="nav-link" href="<?php echo e(url('/calendar')); ?>">
                            <span class="nav-span">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="modal-content" style="border-radius: 12px; border: none; box-shadow: 0 4px 20px rgba(0,0,0,0.15);">
            <div class="modal-body" style="padding: 32px;">
                ...
                <div class="d-flex" style="gap: 12px;">
                    ...
                    <a href="<?php echo e(url('/logout')); ?>" class="btn flex-fill" style="background-color: #DC3545; color: #fff; border: none; border-radius: 8px; padding: 12px; font-weight: 500; text-decoration: none; text-align: center; display: flex; align-items: center; justify-content: center;">Logout</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content" style="border-radius: 12px; border: none; box-shadow: 0 4px 20px rgba(0,0,0,0.15);">
            ...
            <div class="modal-body" style="padding: 0;">
                <form id="addClientForm" action="<?php echo e(url('/clients')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<div class="modal fade" id="addJobModal" tabindex="-1" aria-labelledby="addJobModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content" style="border-radius: 12px; border: none; box-shadow: 0 4px 20px rgba(0,0,0,0.15);">
            ...
            <div class="modal-body" style="padding: 0;">
                <form id="addJobForm" action="<?php echo e(url('/addJob')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="card h-100" style="border: none; box-shadow: none;">
                        <div class="card-header" style="border-bottom: 1px solid #E5E5E5;">
                            <ul class="nav nav-tabs" role="tablist">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        //const defaultAvatar = "<?php echo e(asset('public/uploads') . '/defaultProfilePic.jpg'); ?>";
        let defaultAvatar = "";
        if(preview){
...
<script src="<?php echo e(asset('public/')); ?>/assets/js/pages/hospital-index.init.js"></script>
<script src="<?php echo e(asset('public/')); ?>/assets/libs/simple-datatables/umd/simple-datatables.js"></script>
<script src="<?php echo e(asset('public/')); ?>/assets/libs/fullcalendar/main.min.js"></script>
...
<?php echo $__env->make('modals.edit_client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.edit-client-btn', function(e) {
            ...
            $.ajax({
                url: '<?php echo e(url('/')); ?>/clients/' + clientId + '/data',
                method: 'GET',
                dataType: 'json',
                success: function(response) {
                    if (response.success && response.client) {
                        ...
                        // Set form action
                        $('#editClientForm').attr('action', '<?php echo e(url('/')); ?>/clients/' + clientId);
    ...
    $(document).ready(function() {
        ...
        $('#addJobModal').on('show.bs.modal', function () {
            // Load clients list
            $.ajax({
                url: '<?php echo e(url('/api/clients-list')); ?>',
                method: 'GET',
                dataType: 'json',
                success: function(response) {
            ...
            $.ajax({
                url: '<?php echo e(url('/api/credentials-list')); ?>',
                method: 'GET',
                dataType: 'json',
                success: function(response) {
...
<?php /**PATH /home/u246429533/domains/gemdentalrepair.com/public_html/crm/resources/views/layout.blade.php ENDPATH**/ ?>