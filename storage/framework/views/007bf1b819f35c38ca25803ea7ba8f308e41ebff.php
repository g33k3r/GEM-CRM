                        ...
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                <div class="row align-items-center">
                                    <div class="col-lg-9">
                                        <h4 class="page-title text-white font-30 mb-3 mt-2"><?php echo e($job->client->office_name ?? 'N/A'); ?></h4>
                                        <p class="text-white mb-1"><i class="ti ti-mail"></i>: <?php echo e($job->client->doctor_name ?? 'N/A'); ?></p>
                                        <p class="text-white mb-1"><i class="ti ti-phone"></i>: <?php echo e($job->client->office_number ?? 'N/A'); ?></p>
                                        <p class="text-white mb-1">
                                            <i class="ti ti-home"></i>: <?php echo e($job->client->address ?? 'N/A'); ?><?php echo e($job->client->suite ? ', Suite ' . $job->client->suite : ''); ?><?php echo e($job->client->city ? ', ' . $job->client->city : ''); ?><?php echo e($job->client->state ? ', ' . $job->client->state : ''); ?><?php echo e($job->client->zip_code ? ' ' . $job->client->zip_code : ''); ?>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="row align-items-center">
                                            <div class="col-lg-10 text-lg-end">
                                                ...
                                                ?>
                                                <button type="button" class="btn btn-mystyle dropdown-toggle w-100" data-bs-toggle="dropdown" aria-expanded="false" style="width:fit-content!important"><?php echo e($statusText); ?> <i class="mdi mdi-chevron-down"></i></button>
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item update-job-status" href="#" data-status="pending" data-job-id="<?php echo e($job->id); ?>">Pending</a>
                                                    <a class="dropdown-item update-job-status" href="#" data-status="in_progress" data-job-id="<?php echo e($job->id); ?>">In Progress</a>
                                                    <a class="dropdown-item update-job-status" href="#" data-status="completed" data-job-id="<?php echo e($job->id); ?>">Completed</a>
                                                    <a class="dropdown-item update-job-status" href="#" data-status="cancelled" data-job-id="<?php echo e($job->id); ?>">Cancelled</a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-body h-100">
                                        <div class="tab-content">
                                                        ...
                                                        <div class="row align-items-center mb-3">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                       value="<?php echo e($job->client->office_name ?? ''); ?>" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="row align-items-center mb-3">
                                                            <div class="col-lg-6">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                       value="<?php echo e($job->client->doctor_name ?? ''); ?>" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="row align-items-center mb-3">
                                                            <div class="col-lg-6">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                       value="<?php echo e($job->client->address ?? ''); ?>" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="row align-items-center mb-3">
                                                            <div class="col-lg-6">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                       value="<?php echo e($job->client->zip_code ?? ''); ?>" disabled>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="row align-items-center mb-3">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                       value="<?php echo e($job->client->office_number ?? ''); ?>" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="row align-items-center mb-3">
                                                            <div class="col-lg-6">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                       value="<?php echo e($job->client->last_dos ? $job->client->last_dos->format('m/d/Y') : ''); ?>" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="row align-items-center mb-3">
                                                            <div class="col-lg-6">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                       value="<?php echo e($job->client->suite ?? ''); ?>" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="row align-items-center mb-3">
                                                            <div class="col-lg-6">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                       value="<?php echo e($job->client->city ?? ''); ?>" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="row align-items-center mb-3">
                                                            <div class="col-lg-6">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                       value="<?php echo e($job->client->state ?? ''); ?>" disabled>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        ...
                                                        <div class="row align-items-center mb-3">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                       value="<?php echo e($job->client->compressor_a_model ?? ''); ?>" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="row align-items-center mb-3">
                                                            <div class="col-lg-6">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                       value="<?php echo e($job->client->compressor_a_serial ?? ''); ?>" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="row align-items-center mb-3">
                                                            <div class="col-lg-6">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                       value="<?php echo e($job->client->compressor_a_oem ?? ''); ?>" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="row align-items-center mb-3">
                                                            <div class="col-lg-6">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                       value="<?php echo e($job->client->compressor_a_initial ? $job->client->compressor_a_initial->format('m/d/Y') : ''); ?>" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="row align-items-center mb-3">
                                                            <div class="col-lg-6">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                       value="<?php echo e($job->client->compressor_a_last ? $job->client->compressor_a_last->format('m/d/Y') : ''); ?>" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="row align-items-center mb-3">
                                                            <div class="col-lg-6">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                       ...
                                                                       value="<?php echo e($job->client->compressor_a_next ? $job->client->compressor_a_next->format('m/d/Y') : ''); ?>" disabled>
                                                                <input type="hidden" id="job_compressor_a_next_value"
                                                                       value="<?php echo e($job->client->compressor_a_next ? $job->client->compressor_a_next->format('Y-m-d') : ''); ?>">
                                                            </div>
                                                        </div>
                                                        <div class="row align-items-center mb-3">
                                                            <div class="col-lg-6">
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <div class="row align-items-center mb-3">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                       value="<?php echo e($job->client->compressor_b_model ?? ''); ?>" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="row align-items-center mb-3">
                                                            <div class="col-lg-6">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                       value="<?php echo e($job->client->compressor_b_serial ?? ''); ?>" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="row align-items-center mb-3">
                                                            <div class="col-lg-6">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                       value="<?php echo e($job->client->compressor_b_oem ?? ''); ?>" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="row align-items-center mb-3">
                                                            <div class="col-lg-6">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                       value="<?php echo e($job->client->compressor_b_initial ? $job->client->compressor_b_initial->format('m/d/Y') : ''); ?>" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="row align-items-center mb-3">
                                                            <div class="col-lg-6">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                       value="<?php echo e($job->client->compressor_b_last ? $job->client->compressor_b_last->format('m/d/Y') : ''); ?>" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="row align-items-center mb-3">
                                                            <div class="col-lg-6">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                       ...
                                                                       value="<?php echo e($job->client->compressor_b_next ? $job->client->compressor_b_next->format('m/d/Y') : ''); ?>" disabled>
                                                                <input type="hidden" id="job_compressor_b_next_value"
                                                                       value="<?php echo e($job->client->compressor_b_next ? $job->client->compressor_b_next->format('Y-m-d') : ''); ?>">
                                                            </div>
                                                        </div>
                                                        <div class="row align-items-center mb-3">
                                                            <div class="col-lg-6">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="row align-items-center mb-3">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <input type="text" class="form-control my-input"
                                                                           value="<?php echo e($job->client->water_filter_initial ? $job->client->water_filter_initial->format('m/d/Y') : ''); ?>" disabled>
                                                                </div>
                                                            </div>
                                                            <div class="row align-items-center mb-3">
                                                                <div class="col-lg-6">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <input type="text" class="form-control my-input"
                                                                           value="<?php echo e($job->client->water_filter_next ? $job->client->water_filter_next->format('m/d/Y') : ''); ?>" disabled>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="row align-items-center mb-3">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <input type="text" class="form-control my-input"
                                                                           value="<?php echo e($job->client->water_filter_days ?? ''); ?>" disabled>
                                                                </div>
                                                            </div>
                                                            <div class="row align-items-center mb-3">
                                                                <div class="col-lg-6">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <input type="text" class="form-control my-input"
                                                                           value="<?php echo e($job->client->water_filter_completed ? ucfirst($job->client->water_filter_completed) : ''); ?>" disabled>
                                                                </div>
                                                            </div>
                                                            <div class="row align-items-center mb-3">
                                                                <div class="col-lg-6">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <input type="text" class="form-control my-input"
                                                                           value="<?php echo e($job->client->water_filter_maintenance ? ucfirst($job->client->water_filter_maintenance) : ''); ?>" disabled>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="row align-items-center mb-3">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <input type="text" class="form-control my-input"
                                                                           value="<?php echo e($job->client->silver_filter_initial ? $job->client->silver_filter_initial->format('m/d/Y') : ''); ?>" disabled>
                                                                </div>
                                                            </div>
                                                            <div class="row align-items-center mb-3">
                                                                <div class="col-lg-6">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <input type="text" class="form-control my-input"
                                                                           value="<?php echo e($job->client->silver_filter_next ? $job->client->silver_filter_next->format('m/d/Y') : ''); ?>" disabled>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="row align-items-center mb-3">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <input type="text" class="form-control my-input"
                                                                           value="<?php echo e($job->client->silver_filter_days ?? ''); ?>" disabled>
                                                                </div>
                                                            </div>
                                                            <div class="row align-items-center mb-3">
                                                                <div class="col-lg-6">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <input type="text" class="form-control my-input"
                                                                           value="<?php echo e($job->client->silver_filter_maintenance ? ucfirst($job->client->silver_filter_maintenance) : ''); ?>" disabled>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="row align-items-center mb-3">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <input type="text" class="form-control my-input"
                                                                           value="<?php echo e($job->client->cavitron_filter_initial ? $job->client->cavitron_filter_initial->format('m/d/Y') : ''); ?>" disabled>
                                                                </div>
                                                            </div>
                                                            <div class="row align-items-center mb-3">
                                                                <div class="col-lg-6">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <input type="text" class="form-control my-input"
                                                                           value="<?php echo e($job->client->cavitron_filter_next ? $job->client->cavitron_filter_next->format('m/d/Y') : ''); ?>" disabled>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="row align-items-center mb-3">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <input type="text" class="form-control my-input"
                                                                           value="<?php echo e($job->client->cavitron_filter_days ?? ''); ?>" disabled>
                                                                </div>
                                                            </div>
                                                            <div class="row align-items-center mb-3">
                                                                <div class="col-lg-6">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <input type="text" class="form-control my-input"
                                                                           value="<?php echo e($job->client->cavitron_filter_maintenance ? ucfirst($job->client->cavitron_filter_maintenance) : ''); ?>" disabled>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="row align-items-center mb-3">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                       value="<?php echo e($job->client->amalgam_model ?? ''); ?>" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="row align-items-center mb-3">
                                                            <div class="col-lg-6">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                       value="<?php echo e($job->client->amalgam_initial ? $job->client->amalgam_initial->format('m/d/Y') : ''); ?>" disabled>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="row align-items-center mb-3">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                       value="<?php echo e($job->client->amalgam_next ? $job->client->amalgam_next->format('m/d/Y') : ''); ?>" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="row align-items-center mb-3">
                                                            <div class="col-lg-6">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                       value="<?php echo e($job->client->amalgam_days ?? ''); ?>" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="row align-items-center mb-3">
                                                            <div class="col-lg-6">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                       value="<?php echo e($job->client->amalgam_maintenance ? ucfirst($job->client->amalgam_maintenance) : ''); ?>" disabled>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="row align-items-center mb-3">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                       value="<?php echo e($job->client->sterilizer_model ?? ''); ?>" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="row align-items-center mb-3">
                                                            <div class="col-lg-6">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                       value="<?php echo e($job->client->sterilizer_initial ? $job->client->sterilizer_initial->format('m/d/Y') : ''); ?>" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="row align-items-center mb-3">
                                                            <div class="col-lg-6">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                       value="<?php echo e($job->client->sterilizer_days ?? ''); ?>" disabled>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="row align-items-center mb-3">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                       value="<?php echo e($job->client->sterilizer_next ? $job->client->sterilizer_next->format('m/d/Y') : ''); ?>" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="row align-items-center mb-3">
                                                            <div class="col-lg-6">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                       value="<?php echo e($job->client->sterilizer_days2 ?? ''); ?>" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="row align-items-center mb-3">
                                                            <div class="col-lg-6">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                       value="<?php echo e($job->client->sterilizer_maintenance ? ucfirst($job->client->sterilizer_maintenance) : ''); ?>" disabled>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="tab-pane p-3" id="settings4" role="tabpanel">
                                                <div class="text-end">
                                                    <button type="button" class="btn btn-primary mb-3 note-btn" data-client-id="<?php echo e($job->client_id); ?>">
                                            ...
                                            <div class="tab-pane p-3" id="settings5" role="tabpanel">
                                                <div class="text-end mb-3">
                                                    <button type="button" class="btn btn-primary add-other-item-btn" data-client-id="<?php echo e($job->client_id); ?>">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center mb-3">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control my-input" value="JOB-<?php echo e(str_pad($job->id, 6, '0', STR_PAD_LEFT)); ?>"
                                                       disabled>
                                            </div>
                                        </div>
                                        <div class="row align-items-center mb-3">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control my-input"
                                                       value="<?php echo e($job->service_type ?? ''); ?>" disabled>
                                            </div>
                                        </div>
                                        <div class="row align-items-center mb-3">
                                            <div class="col-lg-6">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control my-input"
                                                       value="<?php echo e($job->visit_date ? $job->visit_date->format('m/d/Y') : ''); ?>"
                                                       disabled>
                                            </div>
                                        </div>
                                        <div class="row align-items-center mb-3">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control my-input"
                                                       value="<?php echo e($job->worker->name ?? 'N/A'); ?>"
                                                       disabled>
                                            </div>
                                        </div>
                                        <div class="row align-items-center mb-3">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control my-input"
                                                       value="<?php echo e(ucfirst(str_replace('_', ' ', $job->job_status ?? 'pending'))); ?>"
                                                       disabled>
                                            </div>
                                        </div>
                                        <div class="margin-top-200">
                                            <a href="#" type="buttom" class="btn btn-primary w-100 mb-3 mark-completed-btn"
                                               style="padding: 13px 3px;" data-job-id="<?php echo e($job->id); ?>">Mark as
                                                completed</a>
                                            <a href="#" type="buttom" class="btn btn-light w-100 reschedule-visit-btn" data-job-id="<?php echo e($job->id); ?>" data-current-date="<?php echo e($job->visit_date ? $job->visit_date->format('Y-m-d') : ''); ?>">Reschedule Visit</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    $(document).ready(function() {
        ...
        function updateJobStatus(jobId, newStatus) {
            $.ajax({
                url: '<?php echo e(url('/jobs')); ?>/' + jobId + '/status',
                method: 'POST',
                data: {
        ...
        $('#rescheduleVisitForm').on('submit', function(e) {
            ...
            $.ajax({
                url: '<?php echo e(url('/jobs')); ?>/' + jobId + '/visit-date',
                method: 'POST',
                data: {
                    _token: '<?php echo e(csrf_token()); ?>',
                    _method: 'PUT',
        ...
        <div class="modal-content" style="border-radius: 12px; border: none; box-shadow: 0 4px 20px rgba(0,0,0,0.15);">
            ...
            <div class="modal-body" style="padding: 24px 32px;">
                <form id="rescheduleVisitForm">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="job_id" id="reschedule_job_id" value="<?php echo e($job->id); ?>">
                    <div class="row mb-3">
                        <div class="col-lg-12">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/gemdental/resources/views/job_view.blade.php ENDPATH**/ ?>