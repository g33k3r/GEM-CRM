                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table" id="datatable_1">
                                                ...
                                                <tr>
                                                    <td>
                                                        <span class="tble-clr">{{ $job->created_at ? $job->created_at->format('m/d/y') : 'N/A' }}</span>
                                                        <p class="mb-0 tble-time">{{ $job->created_at ? $job->created_at->format('h:i a') : '' }}</p>
                                                    </td>
                                                    <td onclick="window.location.href='{{ url('/jobs/' . $job->id) }}'" style="cursor: pointer;">
                                                        <div class="d-flex align-items-center justify-content-between">
                                                            <div>
                                                                <span class="tble-clr">{{ $job->client->office_name ?? 'N/A' }}</span>
                                                                <p class="mb-0 tble-time">Contact Number: {{ $job->client->office_number ?? 'N/A' }}</p>
                                                            </div>
                                                    ...
                                                    <td onclick="window.location.href='{{ url('/jobs/' . $job->id) }}'" style="cursor: pointer;">
                                                        <div class="d-flex align-items-center justify-content-between">
                                                            <div>
                                                                <span class="tble-clr">{{ $job->client->doctor_name ?? 'N/A' }}</span>
                                                                <p class="mb-0 tble-time">Visit Date: {{ $job->visit_date ? $job->visit_date->format('m/d/Y') : 'N/A' }}</p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td><span class="tble-clr">{{ $job->client->city ?? 'N/A' }}</span></td>
                                                    <td><span class="tble-clr">{{ $job->client->zip_code ?? 'N/A' }}</span></td>
                                                    <td>
                                                        <span class="tble-clr">
                                                            {{ $job->client->address ?? '' }}{{ $job->client->suite ? ', Suite ' . $job->client->suite : '' }}{{ $job->client->state ? ', ' . $job->client->state : '' }}
                                                        </span>
                                                    </td>
                                                    <td><span class="tble-clr">{{ $job->service_type ?? 'N/A' }}</span></td>
                                                    <td>
                                                        @php
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            <a class="dropdown-item" href="{{ url('/jobs/' . $job->id) }}"><i class="ti ti-eye" style="margin-right:5px"></i>
                                                                View
                                                            </a>
                                                            <a class="dropdown-item delete-job-btn" href="#" data-job-id="{{ $job->id }}" data-office-name="{{ $job->client->office_name ?? 'N/A' }}">
