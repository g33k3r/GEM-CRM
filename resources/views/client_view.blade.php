                    ...
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            <div class="row align-items-center">
                                <div class="col-lg-9">
                                    <h4 class="page-title text-white font-30 mb-3 mt-2">{{ $client->office_name ?? 'N/A' }}</h4>
                                    <p class="text-white mb-1"> <i class="ti ti-mail"></i>: {{ $client->doctor_name ?? 'N/A' }}</p>
                                    <p class="text-white mb-1"><i class="ti ti-phone"></i>: {{ $client->office_number ?? 'N/A' }}</p>
                                    <p class="text-white mb-1">
                                        <i class="ti ti-home"></i>: {{ $client->address ?? 'N/A' }}{{ $client->suite ? ', Suite ' . $client->suite : '' }}{{ $client->city ? ', ' . $client->city : '' }}{{ $client->state ? ', ' . $client->state : '' }}{{ $client->zip_code ? ' ' . $client->zip_code : '' }}
                                    </p>
                                </div>
                                <div class="col-lg-3">
                                    <div class="row align-items-center">
                                        <div class="col-lg-10 text-lg-end">
                                            <button type="button" class="btn btn-mystyle dropdown-toggle w-100" id="statusDropdownBtn" data-bs-toggle="dropdown" aria-expanded="false" style="width:fit-content!important">{{ ucfirst($client->status ?? 'active') }} <i class="mdi mdi-chevron-down"></i></button>
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item change-status-btn" href="#" data-status="active" data-client-id="{{ $client->id }}">Active</a>
                                                <a class="dropdown-item change-status-btn" href="#" data-status="inactive" data-client-id="{{ $client->id }}">Inactive</a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item edit-client-btn" href="#" data-client-id="{{ $client->id }}"><i class="ti ti-pencil" style="margin-right:5px"></i> Edit</a>
                                ...
                                <div class="card-body h-100">
                                    <div class="par-b">
                                        <div class="d-flex align-items-center justify-content-between mb-2">
                                            ...
                                            <div>
                                                <h2 class="fw-bold" style="font-size:40px">{{ $jobsCompleted ?? 0 }}</h2>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="par-b">
                                        <div class="d-flex flex-column gap-3 justify-content-between mb-2">
                                            ...
                                            <div>
                                                @if(isset($upcomingMaintenanceList) && count($upcomingMaintenanceList) > 0)
                                                    <div class="upcoming-maintenance-list" >
                                                        @foreach($upcomingMaintenanceList as $maintenance)
                                                        <h4 class="mb-0 fw-bold" style="color:#45556C;font-size:18px">{{ $maintenance['type'] }}</h4>
                                                                ...
                                                                <div class="d-flex align-items-center gap-2">
                                                                    ...
                                                                    <div>
                                                                        <p class="mb-0 " style="color:#45556C;font-size:14px">
                                                                            {{ \Carbon\Carbon::now()->diffInDays(\Carbon\Carbon::parse($maintenance['date']), false) }} days remaining
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                <div>
                                                                    <p class="mb-0 fw-bold" style="color:#45556C;font-size:16px">{{ $maintenance['date']->format('d M y') }}</p>
                                                                </div>
                                                            </div>
                                                        @endforeach
                                                    </div>
                                ...
                                <div class="card-body h-100">
                                    <div class="tab-content">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="row align-items-center mb-3">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control my-input" value="{{ $client->office_name ?? '' }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row align-items-center mb-3">
                                                        <div class="col-lg-6">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control my-input" value="{{ $client->doctor_name ?? '' }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row align-items-center mb-3">
                                                        <div class="col-lg-6">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control my-input" value="{{ $client->address ?? '' }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row align-items-center mb-3">
                                                        <div class="col-lg-6">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control my-input" value="{{ $client->zip_code ?? '' }}" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="row align-items-center mb-3">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control my-input" value="{{ $client->office_number ?? '' }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row align-items-center mb-3">
                                                        <div class="col-lg-6">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control my-input"
                                                                value="{{ $client->last_dos ? $client->last_dos->format('m/d/Y') : '' }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row align-items-center mb-3">
                                                        <div class="col-lg-6">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="row align-items-center mb-3">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control my-input"
                                                                value="{{ $client->compressor_a_model ?? '' }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row align-items-center mb-3">
                                                        <div class="col-lg-6">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control my-input"
                                                                value="{{ $client->compressor_a_serial ?? '' }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row align-items-center mb-3">
                                                        <div class="col-lg-6">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control my-input"
                                                                value="{{ $client->compressor_a_oem ?? '' }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row align-items-center mb-3">
                                                        <div class="col-lg-6">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control my-input"
                                                                value="{{ $client->compressor_a_initial ? $client->compressor_a_initial->format('m/d/Y') : '' }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row align-items-center mb-3">
                                                        <div class="col-lg-6">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control my-input"
                                                                value="{{ $client->compressor_a_last ? $client->compressor_a_last->format('m/d/Y') : '' }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row align-items-center mb-3">
                                                        <div class="col-lg-6">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control my-input"
                                                                ...
                                                                value="{{ $client->compressor_a_next ? $client->compressor_a_next->format('m/d/Y') : '' }}" disabled>
                                                            <input type="hidden" id="compressor_a_next_value" 
                                                                value="{{ $client->compressor_a_next ? $client->compressor_a_next->format('Y-m-d') : '' }}">
                                                        </div>
                                                    </div>
                                                    <div class="row align-items-center mb-3">
                                                        <div class="col-lg-6">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="row align-items-center mb-3">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control my-input"
                                                                value="{{ $client->compressor_b_model ?? '' }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row align-items-center mb-3">
                                                        <div class="col-lg-6">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control my-input"
                                                                value="{{ $client->compressor_b_serial ?? '' }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row align-items-center mb-3">
                                                        <div class="col-lg-6">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control my-input"
                                                                value="{{ $client->compressor_b_oem ?? '' }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row align-items-center mb-3">
                                                        <div class="col-lg-6">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control my-input"
                                                                value="{{ $client->compressor_b_initial ? $client->compressor_b_initial->format('m/d/Y') : '' }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row align-items-center mb-3">
                                                        <div class="col-lg-6">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control my-input"
                                                                value="{{ $client->compressor_b_last ? $client->compressor_b_last->format('m/d/Y') : '' }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row align-items-center mb-3">
                                                        <div class="col-lg-6">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control my-input"
                                                                ...
                                                                value="{{ $client->compressor_b_next ? $client->compressor_b_next->format('m/d/Y') : '' }}" disabled>
                                                            <input type="hidden" id="compressor_b_next_value" 
                                                                value="{{ $client->compressor_b_next ? $client->compressor_b_next->format('Y-m-d') : '' }}">
                                                        </div>
                                                    </div>
                                                    <div class="row align-items-center mb-3">
                                                        <div class="col-lg-6">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="row align-items-center mb-3">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                    value="{{ $client->water_filter_initial ? $client->water_filter_initial->format('m/d/Y') : '' }}" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="row align-items-center mb-3">
                                                            <div class="col-lg-6">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                    value="{{ $client->water_filter_next ? $client->water_filter_next->format('m/d/Y') : '' }}" disabled>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="row align-items-center mb-3">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                    value="{{ $client->water_filter_days ?? '' }}" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="row align-items-center mb-3">
                                                            <div class="col-lg-6">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                    value="{{ $client->water_filter_completed ? ucfirst($client->water_filter_completed) : '' }}" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="row align-items-center mb-3">
                                                            <div class="col-lg-6">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                    value="{{ $client->water_filter_maintenance ? ucfirst($client->water_filter_maintenance) : '' }}" disabled>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="row align-items-center mb-3">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                    value="{{ $client->silver_filter_initial ? $client->silver_filter_initial->format('m/d/Y') : '' }}" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="row align-items-center mb-3">
                                                            <div class="col-lg-6">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                    value="{{ $client->silver_filter_next ? $client->silver_filter_next->format('m/d/Y') : '' }}" disabled>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="row align-items-center mb-3">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                    value="{{ $client->silver_filter_days ?? '' }}" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="row align-items-center mb-3">
                                                            <div class="col-lg-6">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                    value="{{ $client->silver_filter_maintenance ? ucfirst($client->silver_filter_maintenance) : '' }}" disabled>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="row align-items-center mb-3">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                    value="{{ $client->cavitron_filter_initial ? $client->cavitron_filter_initial->format('m/d/Y') : '' }}" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="row align-items-center mb-3">
                                                            <div class="col-lg-6">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                    value="{{ $client->cavitron_filter_next ? $client->cavitron_filter_next->format('m/d/Y') : '' }}" disabled>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="row align-items-center mb-3">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                    value="{{ $client->cavitron_filter_days ?? '' }}" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="row align-items-center mb-3">
                                                            <div class="col-lg-6">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                    value="{{ $client->cavitron_filter_maintenance ? ucfirst($client->cavitron_filter_maintenance) : '' }}" disabled>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="row align-items-center mb-3">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control my-input"
                                                                value="{{ $client->amalgam_model ?? '' }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row align-items-center mb-3">
                                                        <div class="col-lg-6">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control my-input"
                                                                value="{{ $client->amalgam_initial ? $client->amalgam_initial->format('m/d/Y') : '' }}" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="row align-items-center mb-3">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control my-input"
                                                                value="{{ $client->amalgam_next ? $client->amalgam_next->format('m/d/Y') : '' }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row align-items-center mb-3">
                                                        <div class="col-lg-6">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control my-input"
                                                                value="{{ $client->amalgam_days ?? '' }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row align-items-center mb-3">
                                                        <div class="col-lg-6">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control my-input"
                                                                value="{{ $client->amalgam_maintenance ? ucfirst($client->amalgam_maintenance) : '' }}" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="row align-items-center mb-3">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control my-input"
                                                                value="{{ $client->sterilizer_model ?? '' }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row align-items-center mb-3">
                                                        <div class="col-lg-6">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control my-input"
                                                                value="{{ $client->sterilizer_initial ? $client->sterilizer_initial->format('m/d/Y') : '' }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row align-items-center mb-3">
                                                        <div class="col-lg-6">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control my-input"
                                                                value="{{ $client->sterilizer_days ?? '' }}" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="row align-items-center mb-3">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control my-input"
                                                                value="{{ $client->sterilizer_next ? $client->sterilizer_next->format('m/d/Y') : '' }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row align-items-center mb-3">
                                                        <div class="col-lg-6">
                                                        ...
                                                        <div class="col-lg-6">
                                                                <input type="text" class="form-control my-input"
                                                                    value="{{ $client->sterilizer_days2 ?? '' }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row align-items-center mb-3">
                                                        <div class="col-lg-6">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control my-input"
                                                                value="{{ $client->sterilizer_maintenance ? ucfirst($client->sterilizer_maintenance) : '' }}" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="tab-pane p-3" id="settings4" role="tabpanel">
                                            <div class="text-end">
                                                <button type="button" class="btn btn-primary mb-3 note-btn" data-client-id="{{ $client->id }}">
                                        ...
                                        <div class="tab-pane p-3" id="settings6" role="tabpanel">
                                            <div class="text-end mb-3">
                                                <button type="button" class="btn btn-primary add-other-item-btn" data-client-id="{{ $client->id }}">
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.change-status-btn', function(e) {
            ...
            const clientId = $(this).data('client-id');
            const currentStatus = '{{ strtolower($client->status ?? "active") }}';
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: '{{ url('/clients') }}/' + clientId + '/status',
                        method: 'PUT',
                        data: {
                            _token: '{{ csrf_token() }}',
                            status: newStatus,
