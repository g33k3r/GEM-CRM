...
@section('content')
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                <div class="row">
                                    <div class="col-md-8">
                                        <h4 class="page-title text-white font-30 mb-2 mt-2">Hello {{ session()->get('adminAuth')[0]['name'] }}.</h4>
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col">
                                                ...
                                                <p class="h4 fw-bold" style="font-size:50px">{{ $upcomingJobsCount ?? 0 }}</p>
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col">
                                                ...
                                                <p class="h4 fw-bold" style="font-size:50px">{{ $pendingTasksCount ?? 0 }}</p>
                                                <h6 class="  mt-2 m-0 font-12 fw-light d-flex align-items-center gap-1">
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col">
                                                ...
                                                <p class="h4 fw-bold" style="font-size:50px">{{ $jobsCompletedCount ?? 0 }}</p>
                                                <h6 class="  mt-2 m-0 font-12 fw-light d-flex align-items-center gap-1">
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col">
                                                ...
                                                <p class="h4 fw-bold" style="font-size:50px">{{ $activeClientsCount ?? 0 }}</p>
                                                <h6 class="  mt-2 m-0 font-12 fw-light d-flex align-items-center gap-1">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const monthlyData = @json($monthlyJobsCompleted ?? []);
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const newClients = @json($newClientsCount ?? 0);
            const repeatedClients = @json($repeatedClientsCount ?? 0);
